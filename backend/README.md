...
## Project Structure
    ...
    ├── testapiautoconnect_118545  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_118545`
...
2. Clone this repo and `cd testapiautoconnect_118545`
